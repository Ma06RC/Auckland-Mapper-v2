...
public abstract class GUI {
	...
	/**
	 * This is called to perform the A* path finder
	 */
	protected abstract void astar();
	
	/**
	 * This is called to restart all the points
	 */
	protected abstract void deselect();
	
	/**
	 * This is called to perform the Articulation point
	 */
	protected abstract void artPts();
	...
	private void initialise() {
		...
		JButton artPts = new JButton("Articulation Pts");
